        ...
        <div className="header-title">
          ...
          {modelInfo && (
            <div className="model-accuracy">
              ...
              <span>Akurasi Model: <strong>{modelInfo.accuracy}</strong></span>
            </div>
          )}
        </div>
          ...
          {modelInfo && (
            <div className="model-details">
              ...
              <div className="detail-grid">
                ...
                <div className="detail-item">
                  <span className="detail-label">Akurasi</span>
                  <span className="detail-value accuracy">{modelInfo.accuracy}</span>
                </div>
                <div className="detail-item">
