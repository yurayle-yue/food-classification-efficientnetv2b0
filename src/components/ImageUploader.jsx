  ...
  return (
    <div className="image-uploader">
        ...
        <div className="image-preview-container">
          <div className="preview-content">
            ...
            <div className="preview-actions">
              <button className="action-btn submit-btn" onClick={onSubmit}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <style jsx>{`
        ...
        .upload-area:hover {
          border-color: #8B9556;
          box-shadow: 0 6px 24px rgba(139, 149, 86, 0.15);
        ...
        .upload-area.drag-active {
          ...
          box-shadow: 0 6px 24px rgba(139, 149, 86, 0.2);
        ...
        .image-preview-wrapper {
          ...
          border-radius: 14px;
          overflow: hidden;
          box-shadow: 0 6px 24px rgba(139, 149, 86, 0.18);
        ...
        .preview-overlay {
          ...
          left: 0;
          right: 0;
          background: linear-gradient(to top, rgba(139, 149, 86, 0.9), transparent);
          padding: 0.85rem;
          display: flex;
        ...
        .cancel-btn:hover {
          ...
          transform: translateY(-2px);
          box-shadow: 0 5px 16px rgba(166, 123, 91, 0.25);
        }
